\documentclass[aspectratio=169, xcolor={table}]{beamer} % Формат 16:9, опция xcolor передана классу

\usepackage{cmap} % Перенесено вверх для корректной работы
\usepackage[T2A]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage[russian]{babel}
\usepackage{PTSans} % Убрана неподдерживаемая опция [sfdefault]
\usepackage{graphicx}
\usepackage{xspace}
\usepackage{psfrag}
\usepackage{hyperref}
...
% Настройка титульного листа (исправлен конфликт с colortbl и hyperref)
...
\author[Михайлов Н. К.]{% Опция в [] убирает предупреждения hyperref в метаданных PDF
  \vbox{% \vbox изолирует tabular от парсера Beamer и предотвращает ошибку \CT@end
    \begin{tabular}{rl}
