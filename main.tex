...
\usepackage{cmap} % Перенесено вверх для корректной работы поиска
...
% Настройка титульного листа (использован minipage вместо tabular во избежание конфликта с colortbl)
...
\author[Михайлов Н. К.]{%
  ...
  \begin{minipage}[t]{0.6\linewidth}
    \raggedright
    Михайлов Николай Кириллович, 932302 \\[0.3cm]
    к.т.н. Пожидаев Михаил Сергеевич
  \end{minipage}%
}
\date{} 
