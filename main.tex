...
\begin{center}
    \includegraphics[width=\textwidth, height=0.75\textheight, keepaspectratio]{scheme4.png}
\end{center}
\end{frame}
...
\frametitle{Актуальность}
\begin{center}
    \includegraphics[width=\textwidth, height=0.75\textheight, keepaspectratio]{scheme5.png}
\end{center}
\end{frame}
